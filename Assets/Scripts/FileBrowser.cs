...
public class FileBrowser : MonoBehaviour
{
    ...
    public void SetupFilePanel(string startPath, string fileExtensions = "")
    {
        if(defaultPath != startPath || extensionFilter != fileExtensions)
        {
    ...
    public void Show()
    {
        ...
        fileSelectedEvent = new UnityEvent();
    }
